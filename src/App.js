...
const SERVICES = [
  { category: "Cabelos", items: ["Corte Feminino", "Corte Masculino", "Escova", "Progressiva", "Hidratação", "Coloração", "Mechas & Luzes", "Cauterização"] },
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sobre-img-card svg { width: 60%; opacity: .35; }
        .sobre-badge {
      ...
      <header className={scrolled ? "scrolled" : ""}>
        ...
        <nav className="desktop">
          ...
          <a className="cta-btn" href="https://wa.me/5543999999999" target="_blank" rel="noreferrer">Agendar</a>
        </nav>
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        <a className="cta-btn" href="https://wa.me/5543999999999" target="_blank" rel="noreferrer">Agendar Agora</a>
      </div>
      ...
      <section id="hero" data-section="Início">
        ...
        <div className="hero-actions">
          <a className="cta-btn" href="https://wa.me/5543999999999" target="_blank" rel="noreferrer">Agendar pelo WhatsApp</a>
        ...
        >
          <div className="sobre-img-card">
            <svg viewBox="0 0 120 160" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M60 20 C40 20 25 38 25 60 C25 90 45 110 60 130 C75 110 95 90 95 60 C95 38 80 20 60 20Z" fill="rgba(200,121,138,.4)"/>
              <circle cx="60" cy="55" r="18" fill="rgba(200,121,138,.6)"/>
              <path d="M30 115 Q60 130 90 115" stroke="rgba(201,169,110,.5)" strokeWidth="2" fill="none"/>
            </svg>
      ...
      <section id="servicos" data-section="Serviços">
        ...
        <div className="serv-cta">
          ...
          <a className="cta-btn" href="https://wa.me/5543999999999" target="_blank" rel="noreferrer">Falar com a equipe</a>
        </div>
      </section>
        ...
        >
          <div style={{ background: "var(--white)", borderRadius: 16, padding: "2.5rem", boxShadow: "0 4px 32px rgba(200,121,138,.1)" }}>
            ...
            <div className="form-group">
              ...
              <input type="tel" placeholder="(43) 9 9999-9999" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <textarea placeholder="Alguma dúvida ou pedido especial?" />
            </div>
            <a className="cta-btn" href="https://wa.me/5543999999999" target="_blank" rel="noreferrer" style={{ display: "block", textAlign: "center", padding: ".85rem" }}>
      ...
      <footer>
        ...
        <div className="footer-social">
          ...
          <a className="social-btn" href="https://wa.me/5543999999999" target="_blank" rel="noreferrer">
      ...
      {/* WhatsApp FAB */}
      <a className="wa-fab" href="https://wa.me/5543999999999" target="_blank" rel="noreferrer" title="Falar no WhatsApp">
